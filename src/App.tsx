...
function App() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-white">AutomateAI</span>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="max-w-2xl w-full">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-cyan-200 mb-6 animate-slide-right leading-tight">
                  Transform Your Business with AI Automation
                </h1>
                <p className="text-lg sm:text-xl text-gray-300 mb-8 animate-slide-right animation-delay-200">
                  Harness the power of artificial intelligence to streamline operations, boost productivity, and drive growth with our cutting-edge automation solutions.
                </p>
              ...
              <div className="w-full lg:w-auto grid grid-cols-2 gap-4 sm:gap-6 animate-slide-right animation-delay-600">
                {stats.slice(0, 4).map((stat, index) => (
                  <div 
                    key={index}
                    className="bg-gray-800/30 backdrop-blur-sm p-4 sm:p-6 rounded-xl border border-cyan-500/10 hover:border-cyan-500/20 transition-all duration-300"
                  >
      ...
      {/* Features Section */}
      <section id="features" className="py-16 sm:py-24 bg-gray-900 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,_rgba(6,182,212,0.1),transparent_70%)]" />
            ...
            {[
              {
                ...
                description: "Process thousands of tasks simultaneously with our high-performance AI engine."
              },
              {
              ...
              },
              {
                ...
                description: "Real-time insights and predictive analytics to drive better decisions."
              },
              {
                icon: <Clock className="w-6 h-6" />,
                title: "24/7 Availability",
                description: "Round-the-clock operation with automated monitoring and alerts."
              }
            ].map((feature, index) => (
              <div 
                key={index}
                className="group bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 hover:bg-gray-800/50 transition-all duration-300 border border-gray-700/50 hover:border-cyan-500/50"
              >
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start gap-6 mb-6 sm:mb-8">
                  <div className="flex-shrink-0">
                    <div className="w-12 sm:w-16 h-12 sm:h-16 rounded-xl bg-gradient-to-br from-cyan-500/20 to-cyan-500/5 flex items-center justify-center">
      ...
      <section id="testimonials" className="py-16 sm:py-24 bg-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote: "We reduced our processing time by 75% and saved over $200,000 in operational costs within the first 6 months.",
                author: "Sarah Chen",
                position: "COO, TechCorp Solutions",
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-gray-900 via-gray-900 to-gray-900/95 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,_rgba(6,182,212,0.1),transparent_70%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,_rgba(6,182,212,0.05),transparent_70%)]" />
        </div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-100 mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
              <div className="bg-gray-800/30 backdrop-blur-sm p-6 rounded-xl border border-cyan-500/10 hover:border-cyan-500/20 transition-all duration-300">
                <div className="text-cyan-400 mb-3">
                  <TrendingUp className="h-8 w-8 mx-auto" />
                </div>
                <h3 className="text-white font-semibold mb-2">Boost Efficiency</h3>
                <p className="text-gray-400 text-sm">Cut operational costs by up to 40% with AI automation</p>
              </div>
              <div className="bg-gray-800/30 backdrop-blur-sm p-6 rounded-xl border border-cyan-500/10 hover:border-cyan-500/20 transition-all duration-300">
                <div className="text-cyan-400 mb-3">
                ...
                <p className="text-gray-400 text-sm">Automate repetitive tasks and save 15+ hours per week</p>
              </div>
              <div className="bg-gray-800/30 backdrop-blur-sm p-6 rounded-xl border border-cyan-500/10 hover:border-cyan-500/20 transition-all duration-300">
                <div className="text-cyan-400 mb-3">
                ...
                <p className="text-gray-400 text-sm">Handle 3x more tasks without adding headcount</p>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="px-8 py-4 bg-transparent border-2 border-cyan-500/50 text-cyan-400 rounded-full hover:border-cyan-400 hover:text-cyan-300 transition-all duration-300 text-lg font-semibold flex items-center justify-center group">
                View Case Studies
      ...
      <div className="fixed bottom-8 right-8 z-40">
        <button 
          onClick={() => setShowChat(true)}
          className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 group"
        >
      ...
      {/* Chat Modal */}
      <div className={`fixed inset-0 bg-gray-900/95 backdrop-blur-sm z-50 transition-all duration-300 ${
        ...
        <div className="min-h-screen flex items-center justify-center p-4">
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 max-w-lg w-full border border-cyan-500/20">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold text-white">Chat with Our AI Expert</h3>
              <button 
            ...
            <div className="space-y-6">
              <div className="bg-gray-900/50 rounded-xl p-4 text-gray-300">
                <p className="mb-2 text-cyan-400 font-medium">AI Expert</p>
                <p>Hello! I'm your AI automation expert. I'd love to learn about your business needs and show you how we can help automate your processes. What challenges are you looking to solve?</p>
              </div>
              ...
              <div className="space-y-4">
                <textarea 
                  ...
                  className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 min-h-[100px] resize-none"
                />
                <div className="flex justify-between items-center">
                  <p className="text-sm text-gray-400">Our team typically responds in under 5 minutes</p>
                  <button className="px-6 py-2 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-lg hover:from-cyan-400 hover:to-cyan-500 transition-all duration-300 font-semibold flex items-center">
                    Send Message
              ...
              <div className="border-t border-gray-700 pt-6">
                <p className="text-sm text-gray-400 mb-4">Quick Questions</p>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <button 
                      ...
                      className="px-4 py-2 bg-gray-900/50 text-gray-300 rounded-full hover:bg-gray-900 transition-all duration-300 text-sm"
                    >
                      {question}
                    </button>
                  ))}
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="bg-gray-800/50 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-gray-700 hover:border-cyan-500/50 transition-all duration-500">
      ...
      <footer className="bg-gray-900 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center text-gray-400">
            &copy; 2025 AutomateAI. All rights reserved.
          </div>
        </div>
      </footer>
